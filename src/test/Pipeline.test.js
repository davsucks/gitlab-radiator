...
describe('<Pipeline />', () => {
  describe('when the pipeline succeeds', () => {
    it('renders the pipeline in a green box', () => {
      const wrapper = shallow(<Pipeline pipeline={{ id: 'test', name: 'test', ref: 'test', status: 'success' }} />);
  ...
  describe('when the pipelines fails', () => {
    it('renders the pipeline in a red box', () => {
      const wrapper = shallow(<Pipeline pipeline={{ id: 'test', name: 'test', ref: 'test', status: 'failure' }} />);
